 ...
 * maintain proper alignment. The padding at the end of entries serves a second
 * purpose beyond alignment: it guarantees at least MPRING_PAYLOAD_ALIGN bytes
 * of trailing space in the buffer, which is always enough to fit a padding
 * header.
 */
